 ...
 * 
 */
@WebServiceClient(name = "userService", targetNamespace = "http://service.cxf.cn/", wsdlLocation = "http://localhost:9999/userService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://service.cxf.cn/", "userService");
    ...
    public IUserService getUserServiceImplPort() {
        return super.getPort(new QName("http://service.cxf.cn/", "UserServiceImplPort"), IUserService.class);
    }
    ...
    public IUserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.cxf.cn/", "UserServiceImplPort"), IUserService.class, features);
    }
